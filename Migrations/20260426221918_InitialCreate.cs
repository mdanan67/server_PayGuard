        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "parent"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSentToChildren = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParentBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParentBalances_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentBalances_UserId",
                table: "ParentBalances",
                column: "UserId",
                unique: true);
